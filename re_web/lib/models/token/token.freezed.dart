...
class _$TokenTearOff {
  ...
  _Token call(
      {required String image, required String name, required double balance}) {
    return _Token(
      image: image,
      name: name,
      balance: balance,
...
abstract class $TokenCopyWith<$Res> {
  ...
  $Res call({String image, String name, double balance});
}
...
class _$_Token implements _Token {
  const _$_Token(
      {required this.image, required this.name, required this.balance});
  ...
  @override
  String toString() {
    return 'Token(image: $image, name: $name, balance: $balance)';
  }
